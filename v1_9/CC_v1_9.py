...
excel_icon = ""
def on_closing():
    sys.exit()
...
def select_output_folder():
    ...
    if folder_path:
        ...
        if page4.winfo_ismapped():
            output_folder_entry_excel.delete(0, tk.END)  
            output_folder_entry_excel.insert(0, folder_path) 
...
# Add function to process Excel file
def process_excel_data():
    progress = ProgressHandler(progress_spinner_excel, status_label_excel, root)
    
    try:
        progress.start("Processing Excel file...")
        excel_path = excel_file_entry.get()
        output_folder = output_folder_entry_excel.get()
        
        if not excel_path or not output_folder:
            messagebox.showerror("Error", "Please select both the Excel file and the output folder.")
            return
        ...
        progress.update("Reading Excel data...")
        dataframes = read_excel_datasets(excel_path)
        ...
        ip_data_df = read_ip_data(excel_path)
        
        # Empty lists/dicts for data that wouldn't be available from just the Excel file
        id_photos = []
        associate_data = {}
        formatted_associate_data = []
        ...
        output_dir = output_folder_entry_excel.get() or os.getcwd()
        log_error(e, output_dir)
        messagebox.showerror("Error", "An error occurred while processing your data. Detailed error information has been logged to 'Cash_Crawler_Error_log.txt' in the output directory. Please submit it to North Loop Consulting for support.")
...
for page in (splashpage, page0, page1, page2, page3, page4):
...
excel_icon_img = tk.PhotoImage(data=base64.b64decode(excel_icon))
ttk.Button(page1, text="Excel File", image=excel_icon_img, compound="top", command=lambda: show_page(page4)).grid(row=1, column=2, padx=20, pady=20, sticky="nsew")
...
# Page 4: Process Excel file
ttk.Label(page4, text="Excel File:").grid(row=0, column=0, padx=10, pady=10, sticky="e")
excel_file_entry = ttk.Entry(page4, width=50)
excel_file_entry.grid(row=0, column=1, padx=10, pady=10)
ttk.Button(page4, text="Browse", command=select_excel_file).grid(row=0, column=2, padx=10, pady=10)

ttk.Label(page4, text="Output Folder:").grid(row=1, column=0, padx=10, pady=10, sticky="e")
output_folder_entry_excel = ttk.Entry(page4, width=50)
output_folder_entry_excel.grid(row=1, column=1, padx=10, pady=10)
ttk.Button(page4, text="Browse", command=select_output_folder).grid(row=1, column=2, padx=10, pady=10)

ttk.Button(page4, text="Process Data", command=process_excel_data).grid(row=2, column=0, columnspan=3, pady=20)
ttk.Button(page4, text="Back", command=lambda: show_page(page1)).grid(row=3, column=0, columnspan=3, pady=10)

progress_spinner_excel = ActivityIndicator(page4)
progress_spinner_excel.grid(row=5, column=0, columnspan=3, pady=10)
progress_spinner_excel.grid_remove()
status_label_excel = ttk.Label(page4, text="")
status_label_excel.grid(row=6, column=0, columnspan=3, pady=10)
