...
ttk.Label(splashpage, text="Cash Crawler", font=('Impact', 36)).pack(pady=60)
ttk.Label(splashpage, text="A CashApp Production Parser", font=('Helvetica', 16)).pack(pady=10)
ttk.Label(splashpage, text="v1.0  ©2024 North Loop Consulting, LLC", font=('Helvetica', 16)).pack(pady=10)
ttk.Label(splashpage, text="Loading...", font=('Helvetica', 16)).pack(pady=50)
splashpage.after(4000, lambda: show_page(page0))
# root.after(3000, lambda: show_page(page0))
